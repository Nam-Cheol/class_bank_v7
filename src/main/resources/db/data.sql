...
-- 2. ATM 기기에서 출금 ATM 9999로 가정
-- 1111 계좌에서 100원만 출금하는 history를 만들어 보세요
insert into history_tb(id, amount, w_balance, d_balance, w_account_id, d_account_id, created_at)
values (2, 100, 800, null, 1, null, now());
-- 3. ATM 기기에서 입금
-- 1111 계좌에서 500원만 입금하는 history를 만들어 보세요
insert into history_tb(id, amount, w_balance, d_balance, w_account_id, d_account_id, created_at)
values (3, 500, null, 1300, null, 1, now());